...
const getAllMeals = (meals) => {
  getTotalGoalCalories(meals);  
  getTotalCaloriesConsumed(meals);  
...
const getCalorieRemaining = (meal) => {
  ...
  appendToRemainingCalories(remaining, meal)
}

const appendToRemainingCalories = (remaining, meal) => {
...
const getTotalGoalCalories = (meals) => {
  ...
  appendToTotalGoalCalories(totalGoal)
}

const appendToTotalGoalCalories = (totalGoal) => {
...
const getTotalCaloriesConsumed = (meals) => {
  ...
  appendToTotalCaloriesConsumed(total);
}

const appendToTotalCaloriesConsumed = (total) => {
