...
const prependMeal = (meal) => {
  if (meal.name === "Breakfast") {
    (meal.foods).forEach(function(food) {
      $('.breakfasts').prepend(` 
      <article class='breakfast' data-breakfast-food-id=${food.id}>
          <div contenteditable="true">
            <p class='name'> ${food.name} </p>
          </div>
          <div contenteditable="true">
    ...
    (meal.foods).forEach(function (food) {
      $('.lunches').prepend(` 
      <article class='lunch' data-lunch-food-id=${food.id}>
          <div contenteditable="true">
            <p class='name'> ${food.name} </p>
          </div>
          <div contenteditable="true">
    ...
    (meal.foods).forEach(function (food) {
      $('.dinners').prepend(` 
      <article class='dinner' data-dinner-food-id=${food.id}>
          <div contenteditable="true">
            <p class='name'> ${food.name} </p>
          </div>
          <div contenteditable="true">
    ...
    (meal.foods).forEach(function (food) {
      $('.snacks').prepend(` 
      <article class='snack' data-snack-food-id=${food.id}>
          <div contenteditable="true">
            <p class='name'> ${food.name} </p>
          </div>
          <div contenteditable="true">
