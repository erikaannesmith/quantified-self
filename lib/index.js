...
$('.add-breakfast-btn').on('click', addFoodToBreakfast);
// $('.add-lunch-btn').on('click', addFoodToLunch);
// $('.add-dinner-btn').on('click', addFoodToDinner);
// $('.add-snacks-btn').on('click', addFoodToSnacks);
