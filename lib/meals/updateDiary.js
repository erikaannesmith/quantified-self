import { styleRemainingCalories } from './addMeal';
...
export const updateRemainingCaloriesPostCreate = (food, meal) => {
...
export const updateTotalCaloriesPostCreate = (food, meal) => {
...
export const updateTotalsTablePostCreate = (food, meal) => {
