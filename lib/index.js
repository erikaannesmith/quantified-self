...
const getBreakfastCalorieSum = (meal) => {
  ...
  appendToBreakfastCalories(total)
}

const appendToBreakfastCalories = (total) => {
  $('.breakfast-calorie-sum').append(total);
}
...
const getLunchCalorieSum = (meal) => {
  ...
  appendToLunchCalories(total)
}

const appendToLunchCalories = (total) => {
  $('.lunch-calorie-sum').append(total);
}
...
const getDinnerCalorieSum = (meal) => {
  ...
  appendToDinnerCalories(total)
}

const appendToDinnerCalories = (total) => {
  $('.dinner-calorie-sum').append(total);
}
...
const getSnackCalorieSum = (meal) => {
  ...
  appendToSnackCalories(total)
}

const appendToSnackCalories = (total) => {
  $('.snack-calorie-sum').append(total);
}
