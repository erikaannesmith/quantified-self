...
$('.add-breakfast-btn').on('click', getCheckBoxIds);
$('.add-lunch-btn').on('click', getCheckBoxIds);
$('.add-dinner-btn').on('click', getCheckBoxIds);
$('.add-snacks-btn').on('click', getCheckBoxIds);
