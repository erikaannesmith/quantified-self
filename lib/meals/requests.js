...
export function deleteBreakfastMeal(event) {
  ...
  return fetch(`https://evening-peak-25213.herokuapp.com/api/v1/meals/1/foods/` + foodId, {
    ...
    .then(updateDiary.removeFromMeal(foodId, 'breakfast'))
    .then(updateDiary.updateRemainingCalories(food, 'breakfast'))
    .then(updateDiary.updateTotalCalories(food, 'breakfast'))
