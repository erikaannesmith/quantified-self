...
$('.add-breakfast-btn').on('click', addFoodToMealFirst);
$('.add-lunch-btn').on('click', addFoodToMealFirst);
$('.add-dinner-btn').on('click', addFoodToMealFirst);
$('.add-snacks-btn').on('click', addFoodToMealFirst);
